...
/* harmony export */ });
/* harmony import */ var _chunk_VAUOI2AC_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7277);
/* harmony import */ var _chunk_ICXQ74PX_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10519);
/* harmony import */ var _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(31282);
/* harmony import */ var _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(19463);
/* harmony import */ var _chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(13065);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(30756);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(20271);
...
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(91672);
/* harmony import */ var _upsetjs_venn_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(11832);
/* harmony import */ var roughjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(52274);
...
var addSubsetData = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)((identifierList, label, size) => {
...
var getSubsetData = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(() => {
  return subsets;
}, "getSubsetData");
var normalizeText = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)((text) => {
...
var normalizeStyleValue = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)((value) => {
  return value ? normalizeText(value) : value;
}, "normalizeStyleValue");
var addTextData = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)((identifierList, id, label) => {
...
var addStyleData = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)((identifierList, data) => {
...
var getStyleData = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(() => {
  return styleEntries;
}, "getStyleData");
var normalizeIdentifierList = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)((identifierList) => {
  return identifierList.map((identifier) => normalizeText(identifier));
}, "normalizeIdentifierList");
var validateUnionIdentifiers = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)((identifierList) => {
...
var getTextData = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(() => {
  return textNodes;
}, "getTextData");
var getCurrentSets = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(() => currentSets, "getCurrentSets");
var getIndentMode = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(() => indentMode, "getIndentMode");
var setIndentMode = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)((enabled) => {
  indentMode = enabled;
}, "setIndentMode");
var DEFAULT_VENN_CONFIG = _chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_2__/* .defaultConfig_default */ .UI.venn;
function getConfig2() {
  return (0,_chunk_ICXQ74PX_mjs__WEBPACK_IMPORTED_MODULE_1__/* .cleanAndMerge */ .$t)(DEFAULT_VENN_CONFIG, (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig */ .zj)().venn);
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(getConfig2, "getConfig");
var customClear = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(() => {
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(buildStyleByKey, "buildStyleByKey");
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)((_text, id, _version, diagObj) => {
  const db2 = diagObj.db;
  const config = db2.getConfig?.();
  const { themeVariables, look, handDrawnSeed } = (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig */ .zj)();
  ...
  const dummyD3root = (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .select */ .Ltv)(document.createElement("div"));
  const vennDiagram = _upsetjs_venn_js__WEBPACK_IMPORTED_MODULE_10__/* .VennDiagram */ .py().width(svgWidth).height(svgHeight - titleHeight);
  dummyD3root.datum(renderSets).call(vennDiagram);
  const roughSvg = isHandDrawn ? roughjs__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .A.svg(dummyD3root.select("svg").node()) : void 0;
  const layoutAreas = _upsetjs_venn_js__WEBPACK_IMPORTED_MODULE_10__/* .layout */ .Zp(renderSets, {
    width: svgWidth,
  ...
  const themeDark = (0,khroma__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A)(themeVariables.background || "#f4f4f4");
  dummyD3root.selectAll(".venn-circle").each(function(d, i) {
    const group = (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .select */ .Ltv)(this);
    const data = d;
    ...
    if (isHandDrawn && roughSvg) {
      ...
      if (layoutArea && layoutArea.circles.length > 0) {
        ...
        const roughNode = roughSvg.circle(c.x, c.y, c.radius * 2, {
          roughness: 0.7,
          seed: handDrawnSeed,
          fill: (0,khroma__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A)(baseColor, 0.7),
          fillStyle: "hachure",
          fillWeight: 2,
          hachureGap: 8,
    ...
    const textColor = customStyle?.color || (themeDark ? (0,khroma__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)(baseColor, 30) : (0,khroma__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A)(baseColor, 30));
      ...
      if (customFill) {
        ...
        if (pathD) {
          const roughNode = roughSvg.path(pathD, {
            roughness: 0.7,
            seed: handDrawnSeed,
            fill: (0,khroma__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A)(customFill, 0.3),
  ...
  (0,_chunk_WYO6CB5R_mjs__WEBPACK_IMPORTED_MODULE_2__/* .configureSvgSize */ .a$)(svg, svgHeight, svgWidth, config?.useMaxWidth ?? true);
}, "draw");
function stableSetsKey(setIds) {
  return setIds.join("|");
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(stableSetsKey, "stableSetsKey");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(renderTextNodes, "renderTextNodes");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(ensurePairwiseSubsets, "ensurePairwiseSubsets");
var renderer = { draw };
...
/* harmony export */   py: () => (/* binding */ VennDiagram)
/* harmony export */ });
/* unused harmony exports bestInitialLayout, circleArea, circleCircleIntersection, circleFromPath, circleOverlap, circlePath, computeTextCentre, computeTextCentres, disjointCluster, distance, distanceFromIntersectArea, greedyLayout, intersectionArea, intersectionAreaPath, logRatioLossFunction, lossFunction, normalizeSolution, scaleSolution, sortAreas, venn, wrapText */
const SMALL$1 = 1e-10;
...
const transparentize = (color, amount) => {
    return (0,_adjust_channel_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(color, 'a', -amount);
};
/* EXPORT */
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (transparentize);
